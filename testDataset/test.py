...
def predict(log_lines: list) -> tuple:
    ...
    """
    label_file_path = r'Dataset\test\test_label.csv' # Path to labels file.
    template_embeddings_file_path = r'Dataset\test\template_embs.pickle' # Path to the template embeddings file.
    label2id = {"Normal" : 0,
